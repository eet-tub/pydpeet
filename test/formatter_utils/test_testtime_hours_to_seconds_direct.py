...
class TestTesttimeHoursToSecondsDirect(unittest.TestCase):
    ...
    def test_df_is_none(self, mock_stdout):
        ...
        self.assertEqual(
            ...
            "\033[31mWARNING: Error fixing Test_Time[s] (converting hours to seconds). Reason: dataFrame is None \033[0m\n",
        )
    ...
    def test_df_is_empty(self, mock_stdout):
        ...
        self.assertEqual(
            mock_stdout.getvalue(),
            "\033[31mWARNING: Error fixing Test_Time[s] (converting hours to seconds). Reason: Test_Time[s] is not in dataFrame.columns \033[0m\n",
        )
    ...
    def test_testtime_is_empty(self, mock_stdout):
        ...
        self.assertNotEqual(
            mock_stdout.getvalue(),
            "\033[31mWARNING: Error fixing Test_Time[s] (converting hours to seconds). Reason: could not convert string to float: '' \033[0m\n",
        )
    ...
    def test_convert_testtime(self, mock_stdout):
        ...
        self.assertNotEqual(
            mock_stdout.getvalue(),
            "\033[31mWARNING: Error fixing Test_Time[s] (converting hours to seconds). Reason: Test_Time[s] is empty can't apply time_to_seconds \033[0m\n",
        )
