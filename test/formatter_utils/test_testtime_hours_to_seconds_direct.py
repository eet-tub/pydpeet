...
class TestTesttimeHoursToSecondsDirect(unittest.TestCase):
    ...
    def test_df_is_none(self, mock_stdout):
        ...
        self.assertEqual(mock_stdout.getvalue(), "\033[31mWARNING: Error fixing Testtime[s] (converting hours to seconds). Reason: dataFrame is None \033[0m\n")
    ...
    def test_df_is_empty(self, mock_stdout):
        ...
        self.assertEqual(mock_stdout.getvalue(), "\033[31mWARNING: Error fixing Testtime[s] (converting hours to seconds). Reason: Testtime[s] is not in dataFrame.columns \033[0m\n")
