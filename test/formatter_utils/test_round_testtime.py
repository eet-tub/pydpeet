...
class TestRoundTesttime(unittest.TestCase):
    ...
    def test_df_is_none(self, mock_stdout):
        ...
        self.assertEqual(mock_stdout.getvalue(), "\033[31mWARNING: Error fixing Test_Time[s] (rounding). Reason: dataFrame is None \033[0m\n")
    ...
    def test_df_is_empty(self, mock_stdout):
        ...
        self.assertEqual(mock_stdout.getvalue(), "\033[31mWARNING: Error fixing Test_Time[s] (rounding). Reason: dataframe is empty \033[0m\n")
    ...
    def test_rounding_testtime_as_str(self, mock_stdout):
        ...
        result = round_testtime(data)
        pandas.testing.assert_frame_equal(expected, result)
        self.assertNotEqual(mock_stdout.getvalue(), "\033[31mWARNING: Error fixing Test_Time[s] (rounding). Reason: dataframe is empty \033[0m\n")
    ...
    def test_rounding_testtime_as_str_wrong_format(self, mock_stdout):
        ...
        result = round_testtime(data)
        pandas.testing.assert_frame_equal(expected, result)
        self.assertEqual(mock_stdout.getvalue(), "\033[31mWARNING: Error fixing Test_Time[s] (rounding). Reason: could not convert string to float: 'abc' \033[0m\n")
