...
class TestApplyConvertToFloatIfPossible(unittest.TestCase):
    ...
    def test_None_input(self, mock_stdout):
        ...
        self.assertEqual(
            mock_stdout.getvalue(), "\033[31mWARNING: Error applying convert_to_float_if_possible for A\033[0m\n"
        )
    ...
    def test_column_name_not_in_df(self, mock_stdout):
        ...
        self.assertEqual(
            mock_stdout.getvalue(), "\033[31mWARNING: Error applying convert_to_float_if_possible for B\033[0m\n"
        )
