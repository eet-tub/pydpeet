...
class Test_add_primitive_segments_df:
    ...
    def test_nan_values(self, base_args, caplog, benchmark):
        def _run():
            ...
            assert any(
                f"Column '{Mocks.Mock_add_primitive_segments.required_columns[0]}' contains NaN values."
                in record.message
...
class Test_add_primitive_segments_config:
    ...
    def test_show_runtime_true(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_show_runtime_false(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_show_runtime_none(self, base_args, benchmark):
        def _run():
    ...
    def test_show_runtime_wrong_type(self, base_args, benchmark):
        def _run():
    ...
    def test_check_cv_0aend_true(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_check_cv_0aend_false(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_check_cv_0aend_none(self, base_args, benchmark):
        def _run():
    ...
    def test_check_cv_0aend_wrong_type(self, base_args, benchmark):
        def _run():
    ...
    def test_check_zero_length_true(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_check_zero_length_false(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_check_zero_length_none(self, base_args, benchmark):
        def _run():
    ...
    def test_check_zero_length_wrong_type(self, base_args, benchmark):
        def _run():
    ...
    def test_check_power_zero_w_true(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_check_power_zero_w_false(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_check_power_zero_w_none(self, base_args, benchmark):
        def _run():
    ...
    def test_check_power_zero_w_wrong_type(self, base_args, benchmark):
        def _run():
    ...
    def test_supress_io_warnings_true(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_supress_io_warnings_false(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_supress_io_warnings_none(self, base_args, benchmark):
        def _run():
    ...
    def test_supress_io_warnings_wrong_type(self, base_args, benchmark):
        def _run():
    ...
    def test_precompile_true(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_precompile_false(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_precompile_none(self, base_args, benchmark):
        def _run():
    ...
    def test_precompile_wrong_type(self, base_args, benchmark):
        def _run():
    ...
    def test_force_precompilation_true(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_force_precompilation_false(self, base_args, benchmark):
        def _run():
            original_df = base_args["df"].copy()
    ...
    def test_force_precompilation_none(self, base_args, benchmark):
        def _run():
    ...
    def test_force_precompilation_wrong_type(self, base_args, benchmark):
        def _run():
