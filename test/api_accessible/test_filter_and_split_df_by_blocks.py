...
class Test_filter_and_split_df_by_blocks_df_segments_and_sequences(object):
    #Only first test
    def test_valid(self, base_args):
        raise NotImplementedError("Test not implemented for variable: df_segments_and_sequences of filter_and_split_df_by_blocks")
        ...
        assert pd.DataFrame.equals(result.drop(Mocks.Mock_filter_and_split_df_by_blocks.add_columns, axis=1), original_df)
    ...
    def test_wrong_column_dtypes(self, base_args):
        base_args["VARIABLE"][Mocks.Mock_filter_and_split_df_by_blocks.required_columns] = base_args["VARIABLE"][Mocks.Mock_filter_and_split_df_by_blocks.required_columns].astype(int)
        assert base_args["VARIABLE"][Mocks.Mock_filter_and_split_df_by_blocks.required_columns].dtypes != Mocks.Mock_filter_and_split_df_by_blocks.required_columns_dtypes
        assert_raises_and_print(ValueError, filter_and_split_df_by_blocks, **base_args)
...
class Test_filter_and_split_df_by_blocks_df_primitives(object):
    #Only first test
    def test_valid(self, base_args):
...
class Test_filter_and_split_df_by_blocks_rules(object):
...
class Test_filter_and_split_df_by_blocks_combine_op(object):
...
class Test_filter_and_split_df_by_blocks_print_blocks(object):
...
class Test_filter_and_split_df_by_blocks_also_return_filtered_df(object):
    def test_true(self, base_args):
        raise NotImplementedError(
            "Test not implemented for variable: df_segments_and_sequences of filter_and_split_df_by_blocks")
        original_df = base_args["df"].copy()
