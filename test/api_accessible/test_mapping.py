...
class Test_mapping_data_frame:
    ...
    def test_wrong_column_dtypes(self, base_args):
        base_args["VARIABLE"][Mocks.Mock_mapping.required_columns] = base_args["VARIABLE"][
            Mocks.Mock_mapping.required_columns
        ].astype(int)
        assert (
            base_args["VARIABLE"][Mocks.Mock_mapping.required_columns].dtypes
            != Mocks.Mock_mapping.required_columns_dtypes
        )
        assert_raises_and_print(ValueError, mapping, **base_args)
