...
class Test_visualize_phases_df:
    # Only first test
    def test_valid(self, base_args, caplog, benchmark):
        def _run():
    ...
    def test_wrong_column_dtypes(self, base_args, benchmark):
        def _run():
            ...
            expected_dtypes = pd.Series(
                {col: dtype for col, dtype in Mocks.Mock_visualize_phases.required_columns_dtypes}
            )
    ...
    def test_inf_values(self, base_args, caplog, benchmark):
        def _run():
            ...
            print(f"\nCaptured Warning: {caplog.records[0].message}")
            assert any(
                f"Column '{Mocks.Mock_visualize_phases.required_columns[0]}' contains infinite values."
                in record.message
                for record in caplog.records
            )
...
class Test_visualize_phases_config:
    ...
    def test_use_lines_for_segments_true(self, base_args, caplog, benchmark):
        def _run():
    ...
    def test_use_lines_for_segments_false(self, base_args, caplog, benchmark):
        def _run():
    ...
    def test_use_lines_for_segments_none(self, base_args, benchmark):
        def _run():
    ...
    def test_use_lines_for_segments_wrong_type(self, base_args, benchmark):
        def _run():
    ...
    def test_show_column_names_true(self, base_args, caplog, benchmark):
        def _run():
    ...
    def test_show_column_names_false(self, base_args, caplog, benchmark):
        def _run():
    ...
    def test_show_column_names_none(self, base_args, benchmark):
        def _run():
    ...
    def test_show_column_names_wrong_type(self, base_args, benchmark):
        def _run():
    ...
    def test_show_time_true(self, base_args, caplog, benchmark):
        def _run():
    ...
    def test_show_time_false(self, base_args, caplog, benchmark):
        def _run():
    ...
    def test_show_time_none(self, base_args, benchmark):
        def _run():
    ...
    def test_show_time_wrong_type(self, base_args, benchmark):
        def _run():
    ...
    def test_show_id_true(self, base_args, caplog, benchmark):
        def _run():
    ...
    def test_show_id_false(self, base_args, caplog, benchmark):
        def _run():
    ...
    def test_show_id_none(self, base_args, benchmark):
        def _run():
    ...
    def test_show_id_wrong_type(self, base_args, benchmark):
        def _run():
    ...
    def test_show_runtime_true(self, base_args, caplog, benchmark):
        def _run():
    ...
    def test_show_runtime_false(self, base_args, caplog, benchmark):
        def _run():
