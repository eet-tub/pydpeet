...
from pydpeet.process.sequence.step_analyzer import extract_sequences, add_primitives
...
from pydpeet.process.analyze.soc import SocMethod

# plot import
import matplotlib.pyplot as plt
from matplotlib.colors import LinearSegmentedColormap

def extract_ocv_iocv(min_pause_lenght: float = 120,
                     min_loops: float = 70,
                     visualize: bool = True,
