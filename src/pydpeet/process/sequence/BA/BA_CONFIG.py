...
THRESHOLD_CONSOLE_PRINTS_ZERO_LENGTH_CHECK = 10
THRESHOLD_CONSOLE_PRINTS_CV_CHECK = 10
THRESHOLD_FINETUNING_PRINTS = 10
########################################################################################################################
# Visualize Data
...
SEQUENCES_CONFIG: Dict[str, Dict] = {
    ...
    "Charge_iOCV": {
        "loop": True,
        "min_loops": 2,
        "sequence": ["Pause", "CC_Charge"]
    },
    "CCCV_Charge": {
        "loop": False,
        "sequence": ["CC_Charge", "CV_Charge"]
    },
}
